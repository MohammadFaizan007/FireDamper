...
import com.e.firedamper.adapter.ReArrangeAttributeAdapter;
...
public class ReArrangeAttributeFragment extends Fragment {
    Activity activity;
    Unbinder unbinder;
    @BindView(R.id.edit_attribute_list)
    ListView editAttributeList;
    ReArrangeAttributeAdapter reArrangeAttributeAdapter;

    ArrayList<DeviceClass> deviceList;

    public ReArrangeAttributeFragment() {
...
//        getDevice();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.dashbord_edit_fragment, container, false);
        unbinder = ButterKnife.bind(this, view);
        activity=getActivity();
        if (activity==null)
            return view;
        reArrangeAttributeAdapter =new ReArrangeAttributeAdapter(activity);
        editAttributeList.setAdapter(reArrangeAttributeAdapter);
        return view;
    }
    public void getDevice() {
        ...
        cursor.close();
        reArrangeAttributeAdapter.setList(deviceList);
    }
