...
public class DatabaseConstant {
    ...
    public static final String DATABASE_NAME = "FireDamper.db";             /// Database Name
...
//    public static final String COLUMN_TIMESTAMP = "TIMESTAMP";
    ...
    public static final String COLUMN_DEVICE_AHU_NUMBER ="DEVICE_AHU_NUMBER";
    public static final String COLUMN_DEVICE_AIR_TYPE ="DEVICE_AIR_TYPE";
    public static final String COLUMN_DEVICE_FLOUR_NUMBER ="DEVICE_FLOUR_NUMBER";
    public static final String COLUMN_DEVICE_DAMPER_TYPE ="DEVICE_DAMPER_TYPE";
    ...
    //+COLUMN_DEVICE_ID +"INTEGER PRIMARY KEY AUTOINCREMENT ,"
        public static final String CREATE_DEVICE_TABLE = "CREATE TABLE IF NOT EXISTS " + ADD_DEVICE_TABLE + "("
            ...
            + COLUMN_DEVICE_AHU_NUMBER + " TEXT ,"
            + COLUMN_DEVICE_AIR_TYPE + " TEXT ,"
            + COLUMN_DEVICE_FLOUR_NUMBER + " TEXT ,"
            + COLUMN_DEVICE_DAMPER_TYPE + " TEXT ,"
