package com.e.firedamper.DatabaseModule;
...
import static com.e.firedamper.DatabaseModule.DatabaseConstant.ADD_DEVICE_TABLE;
import static com.e.firedamper.DatabaseModule.DatabaseConstant.COLUMN_DEVICE_AHU_NUMBER;
import static com.e.firedamper.DatabaseModule.DatabaseConstant.COLUMN_DEVICE_AIR_TYPE;
import static com.e.firedamper.DatabaseModule.DatabaseConstant.COLUMN_DEVICE_DAMPER_TYPE;
import static com.e.firedamper.DatabaseModule.DatabaseConstant.COLUMN_DEVICE_FLOUR_NUMBER;
import static com.e.firedamper.DatabaseModule.DatabaseConstant.COLUMN_DEVICE_ID;
import static com.e.firedamper.DatabaseModule.DatabaseConstant.COLUMN_DEVICE_NAME;
import static com.e.firedamper.DatabaseModule.DatabaseConstant.COLUMN_DEVICE_UID;
import static com.e.firedamper.DatabaseModule.DatabaseConstant.COLUMN_GROUP_ID;
import static com.e.firedamper.DatabaseModule.DatabaseConstant.COLUMN_ID;
import static com.e.firedamper.DatabaseModule.DatabaseConstant.DATABASE_NAME;
import static com.e.firedamper.DatabaseModule.DatabaseConstant.DATABASE_VERSION;
import static com.e.firedamper.DatabaseModule.DatabaseConstant.DROP_TABLE;
import static com.e.firedamper.DatabaseModule.DatabaseConstant.GROUP_TABLE_NAME;
...
public class SqlHelper extends SQLiteOpenHelper
{
    ...
    public long insertData(String tableName,ContentValues values)
    {
        ...
        db.replace(ADD_DEVICE_TABLE,null,values);
//        Log.w(TAG1,"a="+a);
//        Cursor cursor=get
// AllData(tableName);
...
//        Log.w(TAG1,"a="+a);
    ...
    //***********************  UPDATE DATA **********************************/
    public boolean updateAttribute(String ID, ContentValues args) {
        SQLiteDatabase db = this.getWritableDatabase();
        return db.update(ADD_DEVICE_TABLE, args, COLUMN_DEVICE_UID + "='" +
                COLUMN_DEVICE_NAME+"='"+
                COLUMN_DEVICE_AHU_NUMBER+"='"+
                COLUMN_DEVICE_AIR_TYPE+"='"+
                COLUMN_DEVICE_FLOUR_NUMBER+"='"+
                COLUMN_DEVICE_DAMPER_TYPE+"='"
                +ID+"'", null) > 0;
    }
    ...
    public boolean removeLight(long ID, ContentValues args) {
        SQLiteDatabase db = this.getWritableDatabase();
...
//        Log.w(TAG1,"name="+tableName+cursor.getCount());
    ...
    public Integer deleteDevice (long uid) {
        SQLiteDatabase db = this.getWritableDatabase();
